## Aspose.OCR for Cloud Ruby SDK Examples
This directory contains examples for [Aspose.OCR for Cloud Ruby SDK]().
...
```ruby
ruby className
e.g. ruby extract_text_from_a_specific_block.rb
```
