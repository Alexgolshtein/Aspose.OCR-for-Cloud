...
Namespace ExtractingManagingOCR.CloudStorage
    ...
    Class ExtractOCRorHOCRTextFromSpecificBlockImage
        ...
        Public Shared Sub Run()
            ...
            Dim rectX As System.Nullable(Of Single) = 150
            Dim rectY As System.Nullable(Of Single) = 100

            'Set Width and Height to recognize text inside.
            Dim rectWidth As System.Nullable(Of Single) = 1000
            Dim rectHeight As System.Nullable(Of Single) = 300
